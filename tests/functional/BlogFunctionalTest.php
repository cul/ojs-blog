...
/**
 * @file tests/functional/blogFunctionalTest.php
 *
...
class blogFunctionalTest extends WebTestCase {
	...
	function testblog() {
		...
		$this->waitForElementPresent($selector = '//input[starts-with(@id, \'select-cell-blogplugin-enabled\')]');
		...
		$this->click('//a[starts-with(@id, \'component-plugins-generic-blog-controllers-grid-staticpagegrid-addStaticPage-button-\')]');
